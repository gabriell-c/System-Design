  ...
  const tone =
    uiNotice.type === "error"
      ...
      : uiNotice.type === "success"
        ...
        : "border-[var(--accent)]/50 bg-slate-950 text-slate-100";

  return (
    <div
      role="status"
      aria-live="polite"
      className={`pointer-events-auto fixed left-1/2 top-4 z-[200] flex max-w-lg -translate-x-1/2 items-start gap-2 rounded-xl border px-4 py-3 text-sm elev-4 ${tone}`}
    >
